...
import pol.rubiano.magic.databinding.ViewRandomCardItemBinding
...
class RandomCardViewHolder(
    ...
    private lateinit var binding: ViewRandomCardItemBinding

    fun bind(randomCard: RandomCard) {
        binding = ViewRandomCardItemBinding.bind(view)
        binding.apply {
